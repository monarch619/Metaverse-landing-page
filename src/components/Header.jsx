    ...
    <Banner>
        ...
        <div className='banner-body'>
          ...
          <motion.div className='banner_intro' variants={containerVariants} initial='initial' animate='animate'>
            <motion.h1 variants={contentVariants}>Find Your <span>Space</span> in the first P2E Built on Algorand BlockChain</motion.h1>
...
{/*--------BANNER-IMAGE--------*/}
          <motion.figure className='astraunat-img' initial={{ y: 70, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 1, duration: .7 }}>
            <img src='https://i.postimg.cc/YSz63MTT/Pngtree-video-game-controller-4830279-removebg-preview.png' alt='astronaut' />
          </motion.figure>
